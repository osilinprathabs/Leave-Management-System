            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.employees.show', $employee) }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left"></i> Back to Employee
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.employees.update', $employee) }}" id="employeeForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('admin.employees.show', $employee) }}" class="btn btn-secondary btn-lg">
        ...
        .then(({ status, body }) => {
            if (status === 200 || status === 201) {
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    text: body.message || 'Employee updated successfully.',
